...
function install_uefi_bootloader {
  ...
  echo "options     root=PARTUUID=${PARTUUID} quiet loglevel=3 systemd.show_status=0 rd.udev.log_priority=3 vga=current vt.global_cursor_default=0 rw ipv6.disable=1" >> /boot/loader/entries/arch.conf
